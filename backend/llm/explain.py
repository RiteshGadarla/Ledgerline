...
async def explain(
    ...
    suggested_action from Phase 0's metadata table."""
    if not exceptions:
        return exceptions, 0, 0
    ...
    return annotated, result.value.input_tokens, result.value.output_tokens
